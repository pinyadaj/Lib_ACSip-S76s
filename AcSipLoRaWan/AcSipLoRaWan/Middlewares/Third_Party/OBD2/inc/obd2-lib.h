...
#define PID0_20_NUM            0x00    //PID 0 - 20 supported
#define PID0_20_DESC               "PID 0x00 - 0x20 Supported"
#define PID1_STATUS_DTC_NUM          0x01    ///
#define PID1_STATUS_DTC_DESC        "Status since DTC Cleared"
#define PID2_FREEZE_DTC_NUM          0x02    ///
#define PID2_FREEZE_DTC_DESC             "Freeze Diagnostic Trouble Code"
#define PID3_FUEL_SYS_STATUS_NUM     0x03    ///
#define PID3_FUEL_SYS_STATUS_DESC        "Fuel System Status"
#define PID4_ENGINE_LOAD_NUM         0x04    //
#define PID4_ENGINE_LOAD_DESC            "Calculated Engine Load"
#define PID5_ENGINE_COOLANT_TEMP_NUM 0x05
#define PID5_ENGINE_COOLANT_TEMP_DESC    "Engine Coolant Temperature"
...
typedef int32_t (obd2_pid_fn_ptr_t) (uint8_t *msg);

typedef struct {
	uint8_t pid_num;
	obd2_pid_fn_ptr_t *pid_fn_ptr;
	char *pid_desc;
} obd2_pid_t;
...
extern const obd2_pid_t pid_map[];
