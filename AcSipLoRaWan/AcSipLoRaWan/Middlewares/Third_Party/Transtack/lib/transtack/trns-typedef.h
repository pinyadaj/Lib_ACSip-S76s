...
#ifndef _TRNS_TYPEDEF_H
#define _TRNS_TYPEDEF_H
...
//} __attribute__ ((packed)) pkt_trns_t;
...
typedef struct {
    ...
    int8_t  *buf_pt;
    int16_t len;
} __attribute__ ((packed)) queue_trns_t;
...
typedef struct {
    ...
    int8_t mode;
} __attribute__ ((packed)) conf_trns_t;
