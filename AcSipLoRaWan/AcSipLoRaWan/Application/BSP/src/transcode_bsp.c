...
//; File Name	 : transcode_bsp.c
//; Programmer   : Nopparat Ninsamran
//; Email@   	 : nopparat@transcodeglobal.com
//; Objective	 : TranscodeGPS Board Support Implementation
...
void Error_Callback(void)
{
  ...
  /* Disable USARTx_IRQn */
  NVIC_DisableIRQ(TELIT_USART_IRQn);
  
  /* Error handling example :
    - Read USART ISR register to identify flag that leads to IT raising
    - Perform corresponding error handling treatment according to flag
  */
  isr_reg = LL_USART_ReadReg(TELIT_USART_INSTANCE, ISR);
