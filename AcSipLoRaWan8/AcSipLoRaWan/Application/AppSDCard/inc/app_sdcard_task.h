...
#ifndef _APP_SDC_TASK_H
#define _APP_SDC_TASK_H
...
extern QueueHandle_t os_queue_sdcard_handle;
extern SemaphoreHandle_t xSDCardSem;
extern TaskHandle_t xSDCardH;
